...
<header class="navbar bg-dark-blue clearfix">
...
****************************************************
 ...
 -->
  <nav>
    <ol class="flex list w-70-ns w-100 center mt3 mb4 pa0" id="stageNav">
      <li>
  ...
  <section id="stage_company" class="dn">
    ...
    <div class="bg-light-gray pa3">
      <ul id="company" class="pa0">
        ...
        <li ami_template_id="company_select_template" class="flex items-center bg-white height-xlarger btn-select btn">
          <div class="flexgrow-1" style="min-width: 5rem">
            <!-- Company logo here -->
            <img src="" ami_template_image_container="logo" class="mr3 w3 h3" alt="Company icon"/>
          </div>
 ...
 -->
  <section id="stage_request" class="dn">
    ...
    <div class="bg-light-gray pa4 f6" id="request">
      ...
      <p ami_template_id="request_company_contact_template">
  ...
  <div class="bg-light-gray pa4 f5">
    ...
    <div id="request_email_address">
      ...
      <address class="f6 pl2 bl bw2 b--white mb2 lh-solid" ami_template_id="request_company_email_template">
          <span class="db" ami_template_value_container="email">
